...
public class MainController {
    ...
    //작성자에 의해서 //판매중 //일자순으로 검색하는 ItemSearchDTO
    //page 현재페이지도 받고  //size도 받고 //pageable도 페이징처리를 위해서 받고
    @GetMapping(value = "/")
    public String main(PageRequestDTO pageRequestDTO, Model model){

//        Pageable pageable = PageRequest.of(page.isPresent()? pageRequestDTO.getPage():0,10);

        //기존에 만들었던 list는 pabeable과 email을 받으므로
