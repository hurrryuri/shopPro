...
import com.example.shoppro.service.CategorysoService;
...
public class SampleController {
    ...
    @PostMapping("/categoryso/register")
    public String savecaso(CategorysoDTO categorysoDTO){

        categorysoService.saveca(categorysoDTO);
